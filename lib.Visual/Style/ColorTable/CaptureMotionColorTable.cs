...
namespace lib.Visual.Style.ColorTable
{
  ...
  /// </summary>
  public class CaptureMotionColorTable : StyleColorTable
  {
    #region Static Fixed Colors - Blue Color Scheme
    private static Color _textMenuStripItem = Color.FromArgb(220, 220, 220);
    private static Color _textContextMenuItem = Color.FromArgb(21, 66, 139);
    ...
    /// </summary>
    public CaptureMotionColorTable()
    {
    }
    #endregion
    ...
    public override Color TextMenuStripItem
    {
      get { return _textMenuStripItem; }
    }

    public override Color TextContextMenuItem
    {
      get { return _textContextMenuItem; }
    }
    #endregion
  }
}
