...
using lib.Visual.Style.ColorTable;
...
namespace lib.Visual.Style
{
    ...
    public class StyleRenderer : ToolStripProfessionalRenderer
    {
        ...
        /// </summary>
        public StyleRenderer(StyleColorTable StyleColorTable)
          : base(StyleColorTable)
        {
          _textMenuStripItem = StyleColorTable.TextMenuStripItem;
          _textContextMenuItem = StyleColorTable.TextContextMenuItem;
        }
        #endregion
