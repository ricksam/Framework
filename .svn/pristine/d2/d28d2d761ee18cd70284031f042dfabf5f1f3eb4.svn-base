/********************************************************************/
/*  VS 2010 Renderer Project                                        */
/*                                                                  */
/*  Use the VS2010Renderer class as a custom renderer by            */
/*  providing it to the ToolStripManager.Renderer property. Then    */
/*  all tool strips, menu strips, status strips etc will be drawn   */
/*  using the VS 2010 style renderer in your application.           */
/*                                                                  */
/*   Author: Phil Wright                                            */
...
namespace lib.Visual.Style.ColorTable
{
    /// <summary>
    /// Provide VS 2010 Blue Theme colors
    /// </summary>
    internal class VS2010ColorTable : ProfessionalColorTable
    {
        ...
        private static Color _menuToolBack = Color.FromArgb(210, 220, 230);
        ...
        private static Color _toolStripBegin = Color.FromArgb(200, 210, 230);
        private static Color _toolStripEnd = Color.FromArgb(170, 180, 200);
        private static Color _toolStripMiddle = Color.FromArgb(190, 200, 220);
        private static Color _buttonBorder = Color.FromArgb(121, 153, 194);
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the VS2010ColorTable class.
        /// </summary>
