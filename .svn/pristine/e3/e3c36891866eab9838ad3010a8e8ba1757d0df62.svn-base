...
namespace lib.Visual.Style
{
    /// <summary>
    /// Draw ToolStrips using the VS 2010 themed appearance.
    /// </summary>
    public class VS2010Renderer : ToolStripProfessionalRenderer
    {
        ...
        /// <summary>
        /// Initialize a new instance of the VS2010Renderer class.
        /// </summary>
        public VS2010Renderer()
          : base(new lib.Visual.Style.ColorTable.VS2010ColorTable())
        {
        }
        #endregion
