...
namespace lib.Unix
{
	public partial class frmMsgInformation
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget lib.Unix.frmMsgInformation
			this.Name = "lib.Unix.frmMsgInformation";
			this.Title = global::Mono.Unix.Catalog.GetString ("dialog1");
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child lib.Unix.frmMsgInformation.VBox
			global::Gtk.VBox w1 = this.VBox;
			w1.Name = "dialog1_VBox";
			w1.BorderWidth = ((uint)(2));
			// Internal child lib.Unix.frmMsgInformation.ActionArea
