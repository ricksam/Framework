...
namespace lib.Class
{
  ...
  public class Conversion
  {
    ...
    #region ToChar
    public char ToChar()
    { try { return Convert.ToChar(_o); } catch { return '\0'; } }
    ...
    #region ToInt
    public int ToInt()
    { try { return Convert.ToInt32(_o); } catch { return 0; } }
    ...
    #region ToLong
    public long ToLong()
    { try { return Convert.ToInt64(_o); } catch { return 0; } }
    ...
    { try { return Convert.ToDouble(_o); } catch { return 0; } }
    ...
    { try { return Convert.ToDecimal(_o); } catch { return 0; } }
    ...
    { try { return Convert.ToDateTime(_o); } catch { return DateTime.MinValue; } }
    ...
    public static ulong BaseForDecimalBase(ushort b, int[] n) {
      ulong r = 0;
      for (int i = 0; i < n.Length; i++)
      {
        int pwr = n.Length - (i + 1);
        r += (ulong)(n[i] * Math.Pow(b, pwr));
      }
      return r;
    }
  }
